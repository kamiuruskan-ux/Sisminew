...
--
-- Petunjuk:
-- Import file ini melalui phpMyAdmin di cPanel / Laragon / XAMPP pada database sekolah Anda.
-- Seluruh tabel menggunakan perintah IF NOT EXISTS sehingga AMAN dan tidak menghapus data lama.
-- ==============================================================================
