...
@section('page_title', 'Formulir Tambah Siswa')

@section('content')
<div class="w-full space-y-6" x-data="{ photoPreview: null }">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 rounded-3xl p-5 border border-slate-200/80 dark:border-slate-800 shadow-xs">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h1 class="text-base sm:text-lg font-black text-slate-900 dark:text-white tracking-tight">Tambah Siswa Baru</h1>
                <p class="text-xs text-slate-500 dark:text-slate-400">Lengkapi formulir pendaftaran data siswa secara lengkap dan presisi.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="lg:col-span-8 space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 shadow-xs space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" placeholder="Masukkan nama lengkap siswa sesuai ijazah" required
                                   class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" placeholder="siswa@sekolah.sch.id" required
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="text" name="nis" value="{{ old('nis') }}" placeholder="No. Induk Sekolah"
                                       class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 shadow-xs space-y-5">
                    ...
                    <div class="space-y-4">
                        ...
                        <x-major-class-select :majors="$majors" :classes="$classes" />
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select name="student_status" class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-semibold rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                                    <option value="active" {{ old('student_status', 'active') == 'active' ? 'selected' : '' }}>Aktif</option>
                                    <option value="alumni" {{ old('student_status') == 'alumni' ? 'selected' : '' }}>Alumni / Lulus</option>
                                    <option value="moved" {{ old('student_status') == 'moved' ? 'selected' : '' }}>Mutasi / Pindah</option>
                                    <option value="dropped" {{ old('student_status') == 'dropped' ? 'selected' : '' }}>Keluar / DO</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="entry_year" value="{{ old('entry_year', date('Y')) }}" placeholder="Misal: 2024"
                                       class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="birth_place" value="{{ old('birth_place') }}" placeholder="Kota tempat lahir"
                                       class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="3" placeholder="Jalan, RT/RW, Kelurahan, Kecamatan, Kota/Kabupaten..."
                                      class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">{{ old('address') }}</textarea>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="parent_name" value="{{ old('parent_name') }}" placeholder="Nama Ayah/Ibu/Wali"
                                       class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                            ...
                            <div>
                                ...
                                <input type="text" name="parent_phone" value="{{ old('parent_phone') }}" placeholder="08xxxxxxxxxx"
                                       class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                        ...
                        <div>
                            ...
                            <input type="text" name="parent_job" value="{{ old('parent_job') }}" placeholder="PNS, Swasta, Wiraswasta, Buruh, Dll."
                                   class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">
                        ...
                        <div>
                            ...
                            <textarea name="parent_address" rows="2" placeholder="Kosongkan jika sama dengan alamat siswa"
                                      class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-xs font-medium rounded-2xl px-4 py-2.5 focus:bg-white dark:focus:bg-slate-850 focus:ring-2 focus:ring-indigo-500 transition">{{ old('parent_address') }}</textarea>
            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div class="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 p-6 shadow-xs space-y-4">
                    ...
                    <div>
                        <x-rupiah-input name="spp_discount" label="Potongan Bulanan (Rp)" :value="old('spp_discount', 0)" show-terbilang />
                    ...
                    <div>
                        ...
                        <input type="text" name="discount_description" value="{{ old('discount_description') }}" placeholder="Misal: Beasiswa Prestasi"
