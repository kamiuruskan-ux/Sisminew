...
<head>
    ...
    <title>Reset Password - {{ Setting::get('school_name', 'Sekolah') }}</title>
...
<body class="min-h-screen bg-slate-50 text-slate-900 relative overflow-x-hidden flex flex-col antialiased">
    ...
    <div class="flex-1 flex flex-col lg:flex-row min-h-screen">
        ...
        <!-- RIGHT SIDE: Light & Modern Reset Password Form Container -->
            ...
            <div class="w-full max-w-md my-auto">
                ...
                <div class="bg-white/80 backdrop-blur-md rounded-3xl p-6 sm:p-10 border border-slate-200/80 shadow-[0_20px_50px_-20px_rgba(15,30,75,0.05)] w-full">
                    ...
                    <div class="mb-8">
                        ...
                        <p class="text-slate-500 text-xs sm:text-sm font-medium">Masukkan password baru Anda untuk memulihkan akun.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('reset-password.submit') }}" 
                        ...
                        <div class="space-y-5">
                            <div>
                                <label for="password" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Password Baru</label>
                            ...
                            <div>
                                <label for="password_confirmation" class="block text-xs font-bold text-slate-700 uppercase tracking-wider mb-1.5">Konfirmasi Password Baru</label>
                                <div class="relative group">
                                    <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-indigo-600 transition-colors pointer-events-none">
                                    ...
                                    <button type="button" @click="showConfirmPassword = !showConfirmPassword" class="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors focus:outline-none" title="Lihat Password">
                            ...
                            <button type="submit" :disabled="loading"
                                ...
                                <span x-show="!loading" class="flex items-center gap-2 justify-center">
                                    ...
                                    <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                </span>
